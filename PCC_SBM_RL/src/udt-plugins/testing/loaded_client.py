...
# print("======================")
# print("Going to print sys var")
# print('\n'.join(sys.path))
# print("======================")


import importlib
numpy_pkg = importlib.find_loader("numpy")
found = numpy_pkg is not None


# print("======================")
print("loaded_client-> python version", sys.version)
print("numpy found:", found)
# print("======================")
